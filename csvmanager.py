...
class CsvManager(object):
    ...
    def updateCSV(self, data):
        with open(self.file, 'w', newline='') as csvfile:
            ...
            csvswriter.writerow([self.file_header[0],self.file_header[1],self.file_header[2],self.file_header[3],self.file_header[4],self.file_header[5],self.file_header[6],self.file_header[7],self.file_header[8]])
